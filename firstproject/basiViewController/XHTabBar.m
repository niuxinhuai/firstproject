...
- (instancetype)initWithFrame:(CGRect)frame
{
    if (self=[super initWithFrame:frame]) {
        ...
        [plusBtn setBackgroundImage:[UIImage imageNamed:@"pointCenter"] forState:UIControlStateNormal];
...
//点击了发布按钮
- (void)plusBtnDidClick:(UIButton *)sender
{
    //如果tabbar的代理实现了对应的代理方法，那么就调用代理的该方法
    if ([self.delegate respondsToSelector:@selector(tabBarPlusBtnClick:withButton:)]) {
        [self.myDelegate tabBarPlusBtnClick:self withButton:sender];
    }
